...
This version works with:
 ...
 - Moodle 5.2 version 2026042000.00 (Build: 20260420) and above within the 5.2 branch.
...
Free software
=============
The theme selector block is 'free' software under the terms of the GNU GPLv3 License, please see '[COPYING.txt](COPYING.txt)'.

It can be obtained for free from: [GitHub](https://github.com/gjbarnard/moodle-block_theme_selector).
...
If you make improvements or bug fixes then I would appreciate if you would send them back to me by forking from [GitHub](https://github.com/gjbarnard/moodle-block_theme_selector) and doing a 'Pull Request' so that the rest of the Moodle community benefits.

Installation
============
1. Follow Moodle's instructions for installing plugins, see: 'Installing Moodle links' above.
